...
namespace Barcodes2.GS1
{
	public class GS1Builder : IEnumerable<GS1Value>
	{
		...
		public System.Collections.ObjectModel.ReadOnlyCollection<GS1Value> Values 
			=> new System.Collections.ObjectModel.ReadOnlyCollection<GS1Value>(_values);

		public GS1Builder()	: this(Code128Helper.FNC1)
		{ }
		...
		public IEnumerator<GS1Value> GetEnumerator() => _values.GetEnumerator();
