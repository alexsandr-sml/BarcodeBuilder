namespace BarcodeLib.Symbologies
{
    ...
    class MSI : BarcodeCommon, IBarcode
    {
        ...
        public MSI(string input, BARCODE_TYPE EncodedType)
        {
        ...
        private string Encode_MSI()
        {
            ...
            //get checksum
            if (Encoded_Type == BARCODE_TYPE.MSI_Mod10 || Encoded_Type == BARCODE_TYPE.MSI_2Mod10)
            {
                string odds = "";
                string evens = "";
            ...
            if (Encoded_Type == BARCODE_TYPE.MSI_Mod11 || Encoded_Type == BARCODE_TYPE.MSI_Mod11_Mod10)
            {
                int sum = 0;
                int weight = 2;
            ...
            if (Encoded_Type == BARCODE_TYPE.MSI_2Mod10 || Encoded_Type == BARCODE_TYPE.MSI_Mod11_Mod10)
            {
